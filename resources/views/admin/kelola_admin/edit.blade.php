...
@section('content')
    ...
    <div class="row">
        <div class="col">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('administrator.manajemen_akun/kelola_admin') }}">Kelola
                            Admin</a></li>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('administrator.manajemen_akun/kelola_admin.update', $admin->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" id="email" class="form-control" required
                        placeholder="Masukan Email" value="{{ $admin->email }}">
                </div>
                <div class="form-group">
                ...
                <div class="text-right">
                    <div class="col-md-10 offset-md-2">
                        ...
                        <a href="{{ route('administrator.manajemen_akun/kelola_admin') }}"
