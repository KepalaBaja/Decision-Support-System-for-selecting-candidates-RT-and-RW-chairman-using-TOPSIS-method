    ...
    @section('content')
        <div class="row">
            <div class="col">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('administrator.data_pendaftaran_rt_rw') }}">Data
                                Pendaftaran
                                RT/RW</a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Detail Calon</li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h5 class="m-0 font-weight-bold text-primary">Detail Calon</h5>
            </div>
            <div class="card-body justify-content-center">
                <form action="{{ route('administrator.data_pendaftaran_rt_rw.update', $pendaftaran->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="form-group row">
                        <div class="col-md-8 offset-md-2">
                            ...
                            <input type="text" name="nama_lengkap" class="form-control"
                                placeholder="Masukan Nama Lengkap" value="{{ $pendaftaran->nama_lengkap }}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-4 offset-md-2">
                            ...
                            <input type="text" name="tempat_lahir" class="form-control"
                                placeholder="Masukan Tempat Lahir" value="{{ $pendaftaran->tempat_lahir }}" readonly>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="text-right">
                        <a href="{{ route('administrator.data_pendaftaran_rt_rw') }}" class="btn btn-primary">Kembali</a>
                    </div>
                </form>
            </div>
        </div>
