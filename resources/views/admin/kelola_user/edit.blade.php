...
@section('content')
    ...
    <div class="row">
        <div class="col">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('administrator.manajemen_akun/kelola_user') }}">Kelola
                            User</a></li>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('administrator.manajemen_akun/kelola_user.update', $user->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="text-right">
                    <div class="col-md-10 offset-md-2">
                        ...
                        <a href="{{ route('administrator.manajemen_akun/kelola_user') }}"
